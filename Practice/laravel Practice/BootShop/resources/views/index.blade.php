...
<!-- Sidebar end=============================================== -->
		<h4>Latest Products </h4>
			  ...
			  @foreach($rows as $row)
				<li class="span3">
					<div class="thumbnail">
						<a  href="./product_details/{{$row->id}}"><img src="{{$row->path}}" alt=""/></a>
						<div class="caption">
						<h5>{{$row->name}}</h5>
						<p> 
							{{$row->details}}
						...
						<h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="./add/{{$row->id}">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">$222.00</a></h4>
						</div>
					</div>
					</li>
			  @endforeach
