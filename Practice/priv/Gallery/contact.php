    ...
    <div class="container-fluid tm-mt-60">
        ...
        <div class="row tm-mb-74 tm-people-row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="img/snehasis.jpg" alt="Image" class="mb-4 img-fluid">
                <h2 class="tm-text-primary mb-4">Snehasis Nandi</h2>
                <h3 class="tm-text-secondary h5 mb-4">Chief Executive Officer</h3>
                <p class="mb-4">
                    Mauris ante tellus, feugiat nec metus non, bibendum semper velit. Praesent laoreet urna id tristique fermentum. Morbi venenatis dui quis.
                </p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="img/shovik.jpg" alt="Image" class="mb-4 img-fluid">
                <h2 class="tm-text-primary mb-4">Shouvik Mukherjee</h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="img/arunava.jpg" alt="Image" class="mb-4 img-fluid">
                <h2 class="tm-text-primary mb-4">Arunava Mondal</h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="img/swarna.jpg" alt="Image" class="mb-4 img-fluid">
                <h2 class="tm-text-primary mb-4">Swarnadwip Nath</h2>
